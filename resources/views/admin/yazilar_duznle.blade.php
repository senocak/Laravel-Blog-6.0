...
@section('body')
    ...
    <div class="w3-container w3-card-4">
        {!! Form::open(array()) !!}
            ...
            @error('icerik') <span class="w3-tag w3-round w3-red" style="padding:3px"><span class="w3-tag w3-round w3-red w3-border w3-border-white">{{ $message }}</span></span><br>@enderror

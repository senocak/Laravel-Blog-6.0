@extends('admin.main')
@section('body')
    <header class="w3-container" style="padding-top:22px"><h5><b><i class="fa fa-dashboard"></i> Genel</b></h5></header>
          ...
          <div class="w3-row">
            <div class="w3-col m2 text-center">
              <a href="/kategori/{{$yorumlar->kategori->url}}">
                <img src="/images/{{$yorumlar->kategori->resim}}" style="width:170px;">
              </a>
            </div>

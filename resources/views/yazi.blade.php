...
@section('body') 
        ...
        <div class="w3-card-4 w3-margin w3-white">
            ...
            <div class="w3-container">
                <b style="font-size: x-large"><a style="text-decoration: none;" href="/yazi/{{ $return_dizi["yazilar"]->url }}">{{$return_dizi["yazilar"]->baslik}}</a></b>
        ...
        <ul class="w3-ul w3-card-4 w3-margin w3-white">
            @foreach ($return_dizi["yazilar"]->yorum as $yorum)
                <li class="w3-bar">
                    ...
                    <img src="/images/img_avatar6.png" class="w3-bar-item w3-circle w3-hide-small" style="width:85px">
